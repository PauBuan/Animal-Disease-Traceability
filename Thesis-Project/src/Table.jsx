      ...
      <header className="bg-[var(--green)] text-white shadow-xl fixed top-0 left-0 right-0 z-50">
        <div className="px-6 lg:px-16 py-5 flex justify-between items-center">
          ...
          <nav className="flex space-x-8 text-lg font-medium">
            <a href="/" className="hover:text-[var(--light-green)] transition">Home</a>
            <a href="/dashboard" className="hover:text-[var(--light-green)] transition">Dashboards</a>
            <a href="/login" className="hover:text-[var(--light-green)] transition">Login</a>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-4xl mx-auto">
              Detailed breakdown across Brgy. Dita, Brgy. Pooc, and Brgy. Macabling.
            </p>
          </div>
                ...
                <tbody>
                  {tableData.map((row, idx) => (
                    ...
                    >
                      ...
                      {/* DITA */}
                      <td className="p-4 text-center text-green-700">{row.dita.healthy}</td>
                      ...
                      {/* POOC */}
                      <td className="p-4 text-center text-green-700">{row.pooc.healthy}</td>
                      ...
                      {/* MACABLING */}
                      <td className="p-4 text-center text-green-700">{row.macabling.healthy}</td>
                  ...
                  <tr className="bg-gradient-to-r from-green-100 to-green-50 font-bold text-gray-800 border-t-4 border-green-300">
                    ...
                    {/* DITA */}
                    <td className="p-4 text-center text-green-700">{totals.dita.healthy}</td>
                    ...
                    {/* POOC */}
                    <td className="p-4 text-center text-green-700">{totals.pooc.healthy}</td>
                    ...
                    {/* MACABLING */}
                    <td className="p-4 text-center text-green-700">{totals.macabling.healthy}</td>
